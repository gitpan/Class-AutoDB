...
sub test {
  ...
  # Test class2colls method (assumes all registrations are on testRegistry)
  my $class='testRegistry';
  my $t_class_colls=$t_saved->class2colls($class) || []; # undocumented interface
  cmp_bag($t_class_colls,\@collections,"$testname: class2colls: objects");
