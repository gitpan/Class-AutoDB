...
ok(grep(/testSerialize/,@refs_real)==$OBJECTS,"after cmp: objects in list are real objects");
ok(grep(/testSerialize/,@refs_real1)==$OBJECTS,"after cmp: objects in list1 are real objects");
ok(grep(/testSerialize/,@refs_real2)==$OBJECTS,"after cmp: objects in list2 are real objects");
