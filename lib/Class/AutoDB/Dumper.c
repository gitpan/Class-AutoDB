...
#line 1 "lib/Class/AutoDB/Dumper.xs"
...
#line 1039 "lib/Class/AutoDB/Dumper.c"
...
#line 1091 "lib/Class/AutoDB/Dumper.c"

XS(XS_Class__AutoDB__Dumper_Dumpxs); /* prototype to pass -Wmissing-prototypes */
XS(XS_Class__AutoDB__Dumper_Dumpxs)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    {
	SV *	href = ST(0);
#line 1042 "lib/Class/AutoDB/Dumper.xs"
	{
	    HV *hv;
	    SV *retval, *valstr;
	    HV *seenhv = NULL;
...
#line 1326 "lib/Class/AutoDB/Dumper.c"
	PUTBACK;
	return;
    }
}
...
extern "C"
#endif
XS(boot_Class__AutoDB__Dumper); /* prototype to pass -Wmissing-prototypes */
XS(boot_Class__AutoDB__Dumper)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        (void)newXSproto_portable("Class::AutoDB::Dumper::Dumpxs", XS_Class__AutoDB__Dumper_Dumpxs, file, "$;$$");
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
